...
| **Tavus account + API key** | Sign up at [platform.tavus.io](https://platform.tavus.io), then go to [API Keys](https://platform.tavus.io/api-keys) | You'll paste the key during setup |
